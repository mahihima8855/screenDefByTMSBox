...
type
  TForm1 = class(TForm)
    ...
    procedure EditëJà⁄èåèKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure EditâÊñ ñºKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
  private
    { Private êÈåæ }
    posX, posY : integer;
...
procedure TForm1.EditâÊñ ñºKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TForm1.EditëJà⁄èåèKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
